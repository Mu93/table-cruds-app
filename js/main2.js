  ...
  for (const data of allData) {
    ...
    let content = `
          <tr>
            ...
            <td>
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#007BFF" class="bi bi-pencil-square"
                viewBox="0 0 16 16">
                <path
    ...
    document.getElementById("data-body").innerHTML += content;
  }
}
readProduct();
